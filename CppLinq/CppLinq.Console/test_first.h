...
namespace simple_test
{
    ...
    inline void RunTestFirstKV(TContainer& cont, std::string label, container_type target) {
        ...
        using val_type = typename TContainer::value_type;
        {
            ...
            std::cout << "First : condition true" << std::endl;
            auto n_2 = From(cont).First([](const auto& elm) {return elm.first == 5; });
            switch (target) {
            case container_type::keyValue   :
            case container_type::multi_kv   :
            case container_type::hash_kv    :
            ...
            std::cout << "First : condition true empty" << std::endl;
            auto n_2_ = From(empty).First([](const auto& elm) {return elm.first == 5; });
            switch (target) {
            case container_type::keyValue   :
            case container_type::multi_kv   :
            case container_type::hash_kv    :
            ...
            std::cout << "First : condition false" << std::endl;
            auto n_3 = From(cont).First([](const auto& elm) {return elm.first == 65; });
            switch (target) {
            case container_type::keyValue   :
            case container_type::multi_kv   :
            case container_type::hash_kv    :
            ...
            std::cout << "First : condition false empty" << std::endl;
            auto n_3_ = From(empty).First([](const auto& elm) {return elm.first == 65; });
            switch (target) {
            case container_type::keyValue   :
            case container_type::multi_kv   :
            case container_type::hash_kv    :
...

        {
            ...
            std::cout << "FirstOrDefault : condition true" << std::endl;
            auto n_2 = From(cont).FirstOrDefault([](const auto& elm) {return elm.first == 5; });
            switch (target) {
            case container_type::keyValue   :
            case container_type::multi_kv   :
            case container_type::hash_kv    :
            ...
            std::cout << "FirstOrDefault : condition true empty" << std::endl;
            auto n_2_ = From(empty).FirstOrDefault([](const auto& elm) {return elm.first == 5; });
            switch (target) {
            case container_type::keyValue   :
            case container_type::multi_kv   :
            case container_type::hash_kv    :
            ...
            std::cout << "FirstOrDefault : condition false" << std::endl;
            auto n_3 = From(cont).FirstOrDefault([](const auto& elm) {return elm.first == 65; });
            switch (target) {
            case container_type::keyValue   :
            case container_type::multi_kv   :
            case container_type::hash_kv    :
            ...
            std::cout << "FirstOrDefault : condition false empty" << std::endl;
            auto n_3_ = From(empty).FirstOrDefault([](const auto& elm) {return elm.first == 65; });
            switch (target) {
            case container_type::keyValue   :
            case container_type::multi_kv   :
            case container_type::hash_kv    :
