...
namespace simple_test
{
    ...
    inline void RunTestContainsKV(TContainer& cont, std::string label, container_type target) {
        ...
        {
            const std::pair<const int, int> c_ = std::make_pair(2, 2);
            std::cout << "Contains elm : no condition true " << std::endl;
            auto n_1 = From(cont).Contains(c_);
            switch (target) {
            case container_type::keyValue   :
            case container_type::multi_kv   :
            case container_type::hash_kv    :
            ...
            std::cout << "Contains elm : no condition true empty" << std::endl;
            auto n_2 = From(empty).Contains(c_);
            switch (target) {
            case container_type::keyValue   :
            case container_type::multi_kv   :
            case container_type::hash_kv    :
        ...
        {
            const std::pair<const int, int> c_ = std::make_pair(99, 99);
            std::cout << "Contains elm : no condition false " << std::endl;
            auto n_1 = From(cont).Contains(c_);
            switch (target) {
            case container_type::keyValue   :
        ...
        {
            const std::pair<const int, int> c_ = std::make_pair(3, 3);
            std::cout << "Contains : true " << std::endl;
            auto n_1 = From(cont).Contains(c_, [](const auto& source, const auto& elm) {return elm == source; });
            switch (target) {
            case container_type::keyValue   :
            case container_type::multi_kv   :
            case container_type::hash_kv    :
            ...
            std::cout << "Contains : true empty" << std::endl;
            auto n_2 = From(empty).Contains(c_, [](const auto& source, const auto& elm) {return elm == source; });
            switch (target) {
            case container_type::keyValue   :
            case container_type::multi_kv   :
            case container_type::hash_kv    :
        ...
        {
            const std::pair<const int, int> c_ = std::make_pair(14, 14);
            std::cout << "Contains : false " << std::endl;
            auto n_1 = From(cont).Contains(c_, [](const auto& source, const auto& elm) {return elm == source; });
            switch (target) {
            case container_type::keyValue   :
            ...
            std::cout << "Contains : false empty" << std::endl;
            auto n_2 = From(cont).Contains(c_, [](const auto& source, const auto& elm) {return elm == source; });
            switch (target) {
            case container_type::keyValue   :
            case container_type::multi_kv   :
            case container_type::hash_kv    :
